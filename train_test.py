...
parser.add_argument('--save_iter',type=int,defautl=100)
...
generator  = Generator(**config.get('generator',dict()))
discriminator = Discriminator(**config.get('discriminator',dict()))
